...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptNoChicago = depts
            .Where(e => e.Loc == "Chicago")
            .Select(d => d.DeptNo);

        List<Emp> result = emps
            .Where(e => deptNoChicago.Contains(e.DeptNo))
            .ToList(); 
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps
            .GroupBy(e => e.DeptNo)
            .Select(d => new { DeptNo = d.Key, Count = d.Count() })
            .ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
            .GroupBy(e => e.DeptNo)
            .Select(d => new {DeptNo = d.Key, AvgSal = d.Average(e => e.Sal)})
            .ToList(); 
